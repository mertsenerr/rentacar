...
// Availability DTOs
public record AvailabilityRequest(string VehicleId, string StartDate, string EndDate);
public record AvailabilityResponse(bool Available, string? Message);
public record VehicleAvailabilityDto(VehicleDto Vehicle, bool IsAvailable);